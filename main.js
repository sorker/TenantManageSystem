          ...
          `, [...(paymentType ? [paymentType] : [])], (err, overdue) => {
            ...
            `, [...(paymentType ? [paymentType] : [])], (err, collection) => {
              ...
              resolve({
                ...
                collectionRateGrowth: 0 // This would require historical data to calculate
              });
            });
          });
        });
  ...
  return new Promise((resolve, reject) => {
    ...
    `, [startDate, endDate], (err, rows) => {
      ...
      resolve(rows.map(row => ({
        ...
        value: row.amount,
        itemStyle: {
          color: type === 'type' ? undefined : undefined // You can add custom colors here
        }
      })));
    });
  });
